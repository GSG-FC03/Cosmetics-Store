...
if (cartTotal.length != 0)
  cartTotal.forEach((element) => { // loop in cartTotal to get contnets
    ...
    myCart += `<p id="quantity">${element.quantity}</p>`;
    myCart += `<p id="priquantityce">${element.price}$</p>`;
    myCart += `<i class="fas fa-minus-circle minussign"></i> <i class="fas fa-plus-circle plussign"></i>
...
else { // if cartTotal empty convert user to MainPage
